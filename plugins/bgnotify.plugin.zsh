#!/usr/bin/env zsh
# https://github.com/t413/zsh-background-notify/blob/master/bgnotify.plugin.zsh
...
if ! (type bgnotify_formatted | grep -q 'function'); then ## allow custom function override
  function bgnotify_formatted { ## args: (exit_status, command, elapsed_seconds)
    ...
    [ $1 -eq 0 ] && bgnotify "$2" "Completed in $elapsed" "$1" || bgnotify "$2" "Failed after $elapsed" "$1"
  }
fi
...
bgnotify () { ## args: (title, subtitle, exit_status)
